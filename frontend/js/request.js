...
request.onreadystatechange = function () { 
    if (this.readyState == XMLHttpRequest.DONE && this.status == 200) { 
        ...
        ButtonModele1.innerHTML=`<a href="produit.html?ID=${response[0]._id}" type="button" class="btn btn-lg btn-outline-primary">Fiche produit du ${response[0].name} </a>`;
        ButtonModele2.innerHTML=`<a href="produit.html?ID=${response[1]._id}" type="button" class="btn btn-lg btn-outline-primary">Fiche produit du ${response[1].name} </a>`;
        ButtonModele3.innerHTML=`<a href="produit.html?ID=${response[2]._id}" type="button" class="btn btn-lg btn-outline-primary">Fiche produit du ${response[2].name} </a>`;
        ButtonModele4.innerHTML=`<a href="produit.html?ID=${response[3]._id}" type="button" class="btn btn-lg btn-outline-primary">Fiche produit du ${response[3].name} </a>`;
        ButtonModele5.innerHTML=`<a href="produit.html?ID=${response[4]._id}" type="button" class="btn btn-lg btn-outline-primary">Fiche produit du ${response[4].name} </a>`;
